...
public abstract class GameObjects {
    ...
    public static Enemy[] InitEnemies(Spell[] enemiesSpells) {
        ...
        //Create human stat
        Stat humanStat = new Stat(7, 7, 6, 6, 30, 30, 3, "Human");
        ...
        //Create elf stat
        Stat elfStat = new Stat(8, 8, 10, 10, 40, 40, 4, "Elf");
        //Create elf enemies
        ...
        //Create orc stat
        Stat orcStat = new Stat(10, 10, 10, 10, 50, 50, 5, "orc");
        //Create orc enemies
        ...
        //Create knight stat
        Stat knightStat = new Stat(12, 12, 15, 15, 70, 70, 7, "Knight");
        //Create knight enemies
        Spell[] knightSpells = new Spell[2];
        knightSpells[0] = enemiesSpells[0];
        knightSpells[1] = enemiesSpells[3];
        enemies[10] = new Enemy(knightStat, "Knight", knightSpells);
        Spell[] assassinKnightSpells = new Spell[2];
        assassinKnightSpells[0] = enemiesSpells[0];
        assassinKnightSpells[1] = enemiesSpells[4];
        enemies[11] = new Enemy(knightStat, "Horseman", assassinKnightSpells);

        //Create demon stat
        Stat demonStat = new Stat(15, 15, 20, 20, 100, 100, 9, "Demon");
        //Create demon enemies
        Spell[] demonSpells = new Spell[2];
        demonSpells[0] = enemiesSpells[0];
        demonSpells[1] = enemiesSpells[1];
        demonSpells[1].setPower(20);
        enemies[12] = new Enemy(demonStat, "Regenerative demon", demonSpells);
