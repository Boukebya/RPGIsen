...
import rpgIsen.Class.gameMechanics.Interaction;

import java.util.Arrays;
import java.util.Objects;
import java.util.Scanner;

import static rpgIsen.Class.wildLife.Spell.cast;
...
public class Hero extends Entity implements Interaction {
    ...
    public int getDexterity() {
        return this.stat.getDexterity();
    }

    public int getLevel() {
        return this.stat.getLevel();
    }
