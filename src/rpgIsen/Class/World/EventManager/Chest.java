...
import static rpgIsen.Class.Equipments.Consumable.addConsumable;
...
public class Chest extends TypeEvents {
    ...
    public void interact(Hero hero, Equipment[] equipments) {
        ...
        Equipment drop = dropItem(equipments);
            ...
            for (int i = 0; i < choices.length; i++) {
                if (Objects.equals(choice, choices[i])) {
                    ...
                    if (i == 0) {
                        ...
                        //if equipment is a consumable
                        if (drop instanceof Consumable) {
                            //add it to the inventory
                            addConsumable((Consumable) drop, hero);
                        }
                        else {

                            hero.equipmentManagement(drop);
                        }
                    }
                    return;
                }
